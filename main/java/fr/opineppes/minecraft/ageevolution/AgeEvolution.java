...
import fr.opineppes.minecraft.ageevolution.events.WorldTickEventListener;
...
public class AgeEvolution implements ModInitializer {
	...
	public void onInitialize() {
		...
		Registry.register(Registry.BLOCK, new Identifier("ageevolution", "fire_extinguisher"), AgeEvolutionBlocks.FIRE_EXTINGUISHER);
		...
		Registry.register(Registry.ITEM, new Identifier("ageevolution", "fire_extinguisher"), new BlockItem(AgeEvolutionBlocks.FIRE_EXTINGUISHER, new Item.Settings().group(GROUP_DECO)));
